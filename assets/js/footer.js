    ...
    <div class="container">
      <div class="row gy-4">
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul class="list-unstyled">
            <li class="mb-2"><a href="website-design-development.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> Website Design & Development</a></li>
            <li class="mb-2"><a href="digital-marketing.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> Digital Marketing</a></li>
            <li class="mb-2"><a href="mobile-application-development.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> Mobile App Development</a></li>
            <li class="mb-2"><a href="paid-advertising.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> Paid Advertising</a></li>
            <li class="mb-2"><a href="rcs-service.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> RCS Service</a></li>
          </ul>
        </div>
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul class="list-unstyled">
            <li class="mb-2"><a href="digital-marketing-agency-education.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> Education</a></li>
            <li class="mb-2"><a href="digital-marketing-agency-healthcare.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> Healthcare</a></li>
            <li class="mb-2"><a href="digital-marketing-agency-ecommerce.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> eCommerce</a></li>
            <li class="mb-2"><a href="digital-marketing-agency-real-estate.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> Real Estate</a></li>
            <li class="mb-2"><a href="digital-marketing-agency-fintech.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> Fintech</a></li>
            <li class="mb-2"><a href="digital-marketing-agency-on-demand.html" class="text-decoration-none"><i class="fa-solid fa-arrow-right"></i> On-Demand</a></li>
          </ul>
        </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-4 d-flex justify-content-center align-items-center footer-links">
          <a href="terms-and-conditions.html" class="text-decoration-none">Terms &amp; Conditions</a>
