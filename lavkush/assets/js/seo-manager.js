(function () {
  ...
  const siteUrl = "https://agilesolutions.co.in";
  const ogImage = "https://agilesolutions.co.in/assets/images/agile-edtech-solutions-logo.png";

  const defaultTitle =
    "Agile Edtech Solutions Pvt Ltd - Website Development Company in Jaipur | Google Ads | Facebook Ads | SEO | Digital Marketing";
  const defaultDescription =
    "Agile Edtech Solutions Pvt Ltd is a top-rated Website Development & Digital Marketing company in Jagatpura, Jaipur. We provide Website Development, Custom Software, Mobile App Development, WhatsApp Marketing, SEO, Google Ads, Facebook Ads, and Lead Generation services.";
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    ensureMeta('meta[name="description"]', { name: "description", content: pageSeo.description });
    ...
    ensureMeta('meta[property="og:title"]', { property: "og:title", content: pageSeo.title });
    ensureMeta('meta[property="og:description"]', { property: "og:description", content: pageSeo.description });
    ...
    ensureMeta('meta[name="twitter:title"]', { name: "twitter:title", content: pageSeo.title });
    ensureMeta('meta[name="twitter:description"]', { name: "twitter:description", content: pageSeo.description });
